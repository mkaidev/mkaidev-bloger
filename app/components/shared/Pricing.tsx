...
export const PricingPlans: iAppProps[] = [
  {
    ...
    priceTitle: "Free",
    benefits: ["1 Site", "Up to 1000 Visitors"],
  },
  {
    id: 1,
    cardTitle: "Startup",
  ...
  return (
    <>
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center leading-tight text-muted-foreground">
        Dapibus curabitur ultrices laoreet aptent tincidunt nibh tempus, libero
        rutrum purus ad sociis aliquam cum fusce, fringilla leo ultricies
        sagittis lacinia neque.
      </p>
